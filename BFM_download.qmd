...
funding_list <- fromJSON(content(full_data_list, "text", encoding = "UTF-8"))$data
...
dir.create("C:/Users/chris/ILSR Dropbox/Christine Parker/Christine Parker/RawData/BFM/bfm_j25_6mar26/", showWarnings = FALSE)
...
walk(file_ids_df$file_id, function(id) {
  ...
  resp <- GET(
    ...
    write_disk(glue("C:/Users/chris/ILSR Dropbox/Christine Parker/Christine Parker/RawData/BFM/bfm_j25_6mar26/file_{id}.zip"), overwrite = TRUE)
  )
